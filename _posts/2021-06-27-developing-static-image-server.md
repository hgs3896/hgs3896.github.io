...
![캐싱적용안된이미지](../images/static_image_no_caching.png)  

 - 매번 요청할 때 마다 이미지를 생성한다면 매번 3.5kB 데이터를 heroku 서버로부터 가져와야할 것이다.

![캐싱적용된다른이미지](../images/other_images_caching.png)  
...
그 결과...
![캐싱적용된이미지](../images/static_image_caching.png)  
